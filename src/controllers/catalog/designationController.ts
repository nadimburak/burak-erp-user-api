...
import Designation from "../../models/catalog/Designation";

const asyncHandler = require("express-async-handler");

const modelTitle = "Designation";
...
export const getAllDesignations = asyncHandler(
  async (req: Request, res: Response) => {
    try {
      ...
      const data = await Designation.find(query)
      ...
      const totalData = await Designation.countDocuments(query);
